			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="<?php echo e(asset('/images/logo.png')); ?>" alt="Edu Logo"></div>
...
<?php /**PATH C:\xampp\htdocs\laravelsiswa\resources\views/auths/login.blade.php ENDPATH**/ ?>