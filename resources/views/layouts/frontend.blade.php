			...
			<div class="container">
				<div class="row d-flex justify-content-between">
					<div class="topbar-left">
						<ul>
							<li><a href="faq-1.html"><i class="fa fa-question-circle"></i>{{config('sekolah.ask')}}</a></li>
							<li><a href="javascript:;"><i class="fa fa-envelope-o"></i>{{config('sekolah.website')}}</a></li>
						</ul>
					</div>
		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<!-- Header Logo ==== -->
					<div class="menu-logo">
						<a href="index.html"><img src="{{config('sekolah.logo_url')}}" alt=""></a>
					</div>
					<!-- Mobile Nav Button ==== -->
							...
							<li class="add-mega-menu"><a href="javascript:;">Our Courses <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu add-menu">
									...
									<li class="add-menu-right">
										<img src="{{asset('/frontend')}}/images/adv/adv.jpg" alt=""/>
									</li>
								</ul>
							</li>
					...
					<div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                        <div class="widget widget_gallery gallery-grid-4">
                            ...
                            <ul class="magnific-image">
								...
								<li><a href="{{asset('/frontend')}}/images/gallery/pic7.jpg" class="magnific-anchor"><img src="{{asset('/frontend')}}/images/gallery/pic7.jpg" alt=""></a></li>
								<li><a href="{{asset('/frontend')}}/images/gallery/pic8.jpg" class="magnific-anchor"><img src="{{asset('/frontend')}}/images/gallery/pic8.jpg" alt=""></a></li>
							</ul>
                        </div>
                    </div>
                </div>
...
<script src="{{asset('/frontend')}}/vendors/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="{{asset('/frontend')}}/vendors/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="{{asset('/frontend')}}/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="{{asset('/frontend')}}/vendors/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="{{asset('/frontend')}}/vendors/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="{{asset('/frontend')}}/vendors/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
