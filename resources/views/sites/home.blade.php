				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="{{asset('/frontend')}}/images/slider/slide1.jpg" alt="" 
							...
							<div class="tp-caption Newspaper-Button rev-btn " 
								...
								style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:var(--primary) !important; border:0; border-radius:30px; margin-right:5px;"><a href="{{config('sekolah.readmore_url')}}">{{config('sekolah.readmore')}}</a></div>
							<div class="tp-caption Newspaper-Button rev-btn" 
								...
								data-paddingbottom="[12,12,12,12]"
								data-paddingleft="[30,35,35,15]"
								style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px;"><a href="{{config('sekolah.contact_url')}}">{{config('sekolah.contact')}}</a></div>
						</li>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Button rev-btn " 
								...
								data-paddingbottom="[12,12,12,12]"
								data-paddingleft="[30,35,35,15]"
								style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:var(--primary) !important; border:0; border-radius:30px; margin-right:5px;"><a href="{{config('sekolah.readmore_url')}}">{{config('sekolah.readmore')}} </div>
							<div class="tp-caption Newspaper-Button rev-btn" 
                ...
                <div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/our-services/pic1.jpg" alt="">
								</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/our-services/pic2.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/our-services/pic3.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
                ...
                <div class="container">
					...
					<div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/courses/pic1.jpg" alt="">
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/courses/pic2.jpg" alt="">
									<a href="#" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/courses/pic3.jpg" alt="">
									<a href="#" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/courses/pic4.jpg" alt="">
									<a href="#" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
				...
				<div class="container">
					...
					<div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
						<div class="item">
							<div class="event-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/event/pic4.jpg" alt="">
								</div>
						...
						<div class="item">
							<div class="event-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/event/pic3.jpg" alt="">
								</div>
								<div class="info-bx d-flex">
									<div>
										<div class="event-time">
						...
						<div class="item">
							<div class="event-bx">
								<div class="action-box">
									<img src="{{asset('/frontend')}}/images/event/pic2.jpg" alt="">
								</div>
								<div class="info-bx d-flex">
									<div>
										<div class="event-time">
						...
						<div class="item">
							<div class="recent-news">
								...
								<div class="info-bx">
									...
									<h5 class="post-title"><a href="{{route('site.single.post', $post->slug)}}">{!!$post->title!!}</a></h5>
									{!!$post->content!!}
									<div class="post-extra">
										<a href="{{route('site.single.post', $post->slug)}}" class="btn-link">READ MORE</a>
