	...
	@section('content')
	 ...
	 <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="page-banner ovbl-dark" style="background-image:url({{asset('/frontend')}}/images/banner/banner2.jpg);">
            <div class="container">
						...
						<div class="col-lg-8 col-xl-8">
							...
							<div class="recent-news blog-lg">
								<div class="action-box blog-lg">
									<img src="{{asset('/frontend')}}/images/blog/default/thum1.jpg" alt="">
								</div>
								<div class="info-bx">
									<ul class="media-post">
										...
										<ol class="comment-list">
											<li class="comment">
												<div class="comment-body">
													<div class="comment-author vcard"> <img  class="avatar photo" src="{{asset('/frontend')}}/images/testimonials/pic1.jpg" alt=""> <cite class="fn">John Doe</cite> <span class="says">says:</span> </div>
												...
												<ol class="children">
													<li class="comment odd parent">
														<div class="comment-body">
															<div class="comment-author vcard"> <img  class="avatar photo" src="{{asset('/frontend')}}/images/testimonials/pic2.jpg" alt=""> <cite class="fn">John Doe</cite> <span class="says">says:</span> </div>
															<div class="comment-meta"> <a href="#">December 02, 2019 at 10:45 am</a> </div>
														...
														<ol class="children">
															<li class="comment odd parent">
																<div class="comment-body">
																	<div class="comment-author vcard"> <img  class="avatar photo" src="{{asset('/frontend')}}/images/testimonials/pic3.jpg" alt=""> <cite class="fn">John Doe</cite> <span class="says">says:</span> </div>
																	<div class="comment-meta"> <a href="#">December 02, 2019 at 10:45 am</a> </div>
																	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae neque vitae sapien malesuada aliquet. 
																		In viverra dictum justo in vehicula. Fusce et massa eu ante ornare molestie. Sed vestibulum sem felis, 
																		ac elementum ligula blandit ac.</p>
						...
						<div class="col-lg-4 col-xl-4">
							<aside  class="side-bar sticky-top">
								...
								<div class="widget widget_gallery gallery-grid-4">
									...
									<ul>
										<li><div><a href="#"><img src="{{asset('/frontend')}}/images/gallery/pic2.jpg" alt=""></a></div></li>
										<li><div><a href="#"><img src="{{asset('/frontend')}}/images/gallery/pic1.jpg" alt=""></a></div></li>
										<li><div><a href="#"><img src="{{asset('/frontend')}}/images/gallery/pic5.jpg" alt=""></a></div></li>
										<li><div><a href="#"><img src="{{asset('/frontend')}}/images/gallery/pic7.jpg" alt=""></a></div></li>
										<li><div><a href="#"><img src="{{asset('/frontend')}}/images/gallery/pic8.jpg" alt=""></a></div></li>
										<li><div><a href="#"><img src="{{asset('/frontend')}}/images/gallery/pic9.jpg" alt=""></a></div></li>
										<li><div><a href="#"><img src="{{asset('/frontend')}}/images/gallery/pic3.jpg" alt=""></a></div></li>
										<li><div><a href="#"><img src="{{asset('/frontend')}}/images/gallery/pic4.jpg" alt=""></a></div></li>
									</ul>
								</div>
